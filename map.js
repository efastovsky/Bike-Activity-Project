...
// Import D3.js as an ESM module
import * as d3 from 'https://cdn.jsdelivr.net/npm/d3@7.9.0/+esm';

// Set your **private** Mapbox access token
mapboxgl.accessToken = 'pk.eyJ1IjoiZWZhc3RvdnNreSIsImEiOiJjbTdqeWlsaTgwMXU3MmlweGc4aWF6azVvIn0.KAHnAFPIsDxx9iPFrqjsTA';
...
// Arrays to store trips by minute
...
map.on('load', () => {
  ...
  function updateCircles(stationData) {
    let stationFlow = d3.scaleQuantize()
        ...
        .range([0, 0.5, 1]);  // Three discrete color levels
    ...
    circles = svg
        ...
        .style("--departure-ratio", d => stationFlow(d.departures / d.totalTraffic)); // Assign ratio
